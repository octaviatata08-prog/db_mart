...
<head>
    ...
    <title>Register - GITAOCMART</title>
...
<body>
    <div class="auth-card">
        ...
        <h4 class="fw-bold text-pink mb-3 text-center">Register</h4>
        <p class="text-muted text-center mb-4">Buat akun baru untuk mengelola toko</p>
        ...
        <div class="text-center mt-3">
            <a href="{{ route('login') }}" class="text-pink fw-bold small">Sudah punya akun? Login</a>
        </div>
    </div>
</body>
</html>